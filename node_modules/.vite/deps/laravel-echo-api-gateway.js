...
var Channel$1 = function(_BaseChannel) {
  _inherits(Channel2, _BaseChannel);
  var _super = _createSuper(Channel2);
  function Channel2(socket, name, options) {
    var _this;
...
var broadcaster = function broadcaster2(options) {
  return new Connector$1(options);
};
var Connector$1 = function(_BaseConnector) {
  _inherits(Connector2, _BaseConnector);
...
export {
  Connector$1 as Connector,
  broadcaster
};
//# sourceMappingURL=laravel-echo-api-gateway.js.map
